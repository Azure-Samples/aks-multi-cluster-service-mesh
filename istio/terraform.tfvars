# name_prefix                           = "horus" set this variable if you want to give a common prefix to the name of all the Azure resources
# admin_username                        = "azadmin" set this variable if you want to SSH into agent nodes using Azure Bastion
# public_ssh_key                        = "ssh-rsa ..." set this variable if you want to SSH into agent nodes using Azure Bastion
...
vnet_two_subnet_prefixes              = ["10.53.0.0/24", "10.53.1.0/24", "10.53.2.0/24", "10.53.3.0/24", "10.53.4.0/24"]
vnet_one_subnet_names                 = ["System", "User", "AppGateway", "AzureBastionSubnet", "PrivateEndpoints"]
vnet_two_subnet_names                 = ["System", "User", "AppGateway", "AzureBastionSubnet", "PrivateEndpoints"]
